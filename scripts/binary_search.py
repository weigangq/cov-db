...
parser.add_argument('-mut', '--mutation_rate', type=int, default=1, help='Number of mutations per generation per haplotype. Will eventually be changed to be random via poisson distribution. Default = 1.')
...
elite.write('gen\tland_id\tland_hap\tland_fit\telite_id\telite_hap\telite_fit\tlandscape\talgorithm\n')
#print(p.elite)
#sys.exit()
