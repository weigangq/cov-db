...
class Population:
    ...
    def combo(self, weight=0.5, nearest_neighbors=10, prob=0.10):
        ...
        #pop_fitness = arr_distances(self.highest_fitness[1], self.pop)  # Get the fitness of the population
        pop_fitness = self.get_fitness(self.pop)
        pop_novelty = self.novelty_search(nearest_neighbors, prob)  # Get the novelty of the population
